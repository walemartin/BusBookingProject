...
namespace BusBookingProject.Admin
{
    public partial class BusScheduleDetails : System.Web.UI.Page
    {
        ...
        private int addBusScheduleData()
        {
            ...
            DateTime availabledate = DateTime.Parse(txtDate.Value);
            DateTime arrival = DateTime.Parse(txtArrival.Value);
            DateTime departure = DateTime.Parse(txtDeparture.Value);
            
            TimeSpan ts = arrival.Subtract(departure);
            sqlCmd.CommandType = CommandType.StoredProcedure;
            sqlCmd.Parameters.AddWithValue("@Date",availabledate.ToShortDateString());
            ...
            sqlCmd.Parameters.AddWithValue("@EstimatdTime", Convert.ToString(ts));
            sqlCmd.Parameters.AddWithValue("@ArrivalTime", Convert.ToString(arrival.ToShortTimeString()));
            sqlCmd.Parameters.AddWithValue("@DepartureTime", Convert.ToString(departure.ToShortTimeString()));
