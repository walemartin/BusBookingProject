                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                           ...
                           <%-- <asp:TextBox ID="txtDate" runat="server" placeholder="DD/MM/YYYY Format" class="form-control input-sm floatlabel"/>--%>
                            <input type="date" id="txtDate" class="form-control input-sm floatlabel" runat="server" />
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                       <%-- <div class="form-group">
                            ...
                            <asp:TextBox ID="txtTravelTime" runat="server" placeholder="00hr00Mins Format" class="form-control input-sm floatlabel"/>
                         ...
                         <div class="form-group">
                            ...
                            <%--<asp:TextBox ID="txtDeparture" placeholder="00:00 AM/PM Format"  runat="server" class="form-control input-sm floatlabel" />--%>
                             <input type="datetime-local" id="txtDeparture" class="form-control input-sm floatlabel" runat="server" />
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                         ...
                         <div class="form-group">
                            ...
                            <%--<asp:TextBox ID="txtArrival" runat="server" placeholder="00:00 AM/PM Format" class="form-control input-sm floatlabel"  />--%>
                             <input type="datetime-local" id="txtArrival" class="form-control input-sm floatlabel" runat="server" />
