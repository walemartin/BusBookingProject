...
namespace BusBookingProject
{
    public partial class Home : System.Web.UI.Page
    {
        ...
        {
            DateTime travel = DateTime.Parse(txtDate.Value);
            Response.Redirect("BusBookingSearchDetails.aspx?Origin="+ddlOrigin.SelectedItem.Text+"&Destination="+ddlDestination.SelectedItem.Text+"&TravelDate="+travel.ToShortDateString());
        }
    }
}